...
mostCurrent._activity.LoadLayout("layout",mostCurrent.activityBA);
 //BA.debugLineNum = 32;BA.debugLine="ScrollView1.Panel.LoadLayout(\"buttons\")";
mostCurrent._scrollview1.getPanel().LoadLayout("buttons",mostCurrent.activityBA);
 //BA.debugLineNum = 33;BA.debugLine="ScrollView1.Panel.Width = 360dip";
mostCurrent._scrollview1.getPanel().setWidth(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (360)));
 //BA.debugLineNum = 34;BA.debugLine="ScrollView1.Panel.Height = 450dip";
mostCurrent._scrollview1.getPanel().setHeight(anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (450)));
...
public static String  _buttonbarcode_click() throws Exception{
 //BA.debugLineNum = 49;BA.debugLine="Sub ButtonBarCode_Click";
 //BA.debugLineNum = 50;BA.debugLine="StartActivity(Bar_Code)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._bar_code.getObject()));
...
mostCurrent._scrollview1 = new anywheresoftware.b4a.objects.ScrollViewWrapper();
 //BA.debugLineNum = 24;BA.debugLine="Private ButtonBarCode As Button";
mostCurrent._buttonbarcode = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 25;BA.debugLine="Private ButttonPrint As Button";
mostCurrent._butttonprint = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Private ButtonBarCodeV2 As Button";
mostCurrent._buttonbarcodev2 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 27;BA.debugLine="Private ButtonNfc As Button";
